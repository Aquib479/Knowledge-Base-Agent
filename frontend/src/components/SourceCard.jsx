...
export default function SourceCard({ source, index }) {
  ...
  const scoreColor = score >= 80 ? 'var(--accent)'
    : score >= 60 ? 'var(--blue)'
    : 'var(--text-2)'
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, minWidth: 0 }}>
          <span style={{
            ...
            fontSize: 9, fontFamily: 'DM Mono', flexShrink: 0,
          }}>{index + 1}</span>
          <span style={{
            fontSize: 11, color: 'var(--text-2)', fontFamily: 'DM Mono',
      ...
      {expanded && (
        <div style={{ padding: '10px 12px' }}>
          <p style={{
            ...
            fontFamily: 'Geist', lineHeight: 1.7,
          }}>
            {source.preview}
          </p>
        </div>
